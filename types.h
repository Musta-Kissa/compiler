...
#define PRIMITIVE_TYPES_ARRAY() { \
    ...
    {.type_kind = BOOL_TYPE, .type_name = "bool", .bool_type.size = BITS_64 }, \
    {.type_kind = INTIGER_TYPE, .type_name = "int", .intiger_type.size = BITS_64 }, \
    {.type_kind = FLOAT_TYPE, .type_name = "float", .float_type.size = BITS_64 }, \
}; \
